...
var readlinePromise = Promise.resolve().then(function () { return require('readline'); });
var inquirerPromise = Promise.resolve().then(function () { return require('inquirer'); });
Promise.all([readlinePromise, inquirerPromise]).then(function (_a) {
    var readline = _a[0], inquirer = _a[1];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                rl.question('Enter your name: ', function (playerName) {
                    console.log("\nHello, ".concat(playerName, "! Your adventure begins!\n"));
            ...
            return __generator(this, function (_a) {
                switch (state) {
                    case GameState.START:
                        ...
                        rl.question('What will you do? (Explore/Quit) ', function (answer) {
                    ...
                    case GameState.EXPLORE:
                        ...
                        rl.question('What will you do? (Continue exploring/Battle/Quit) ', function (answer) {
